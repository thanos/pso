#
#   request.py  - Python Service Objects
#
#   Author: Thanos Vassilakis thanos@0x01.com
#   licience: GPL
#   (c) thanos vassilakis 2000,2001, 2002
#
#   $Id: request.py,v 1.14 2002/06/03 15:53:28 thanos Exp $
#
...
class ServiceRequest(RequestIO):
	...
	# Session handling
	#	
	def getSession(self, sessionImplClass = None, **parameters): 
		...
		"""
		if sessionImplClass is None:
			sessionImplClass = CookieFileImpl
		for k,v in parameters.items():
			self.setEnviron(k, v)
		self.session = Session(self, sessionImplClass())
		if self.session.isNew():
